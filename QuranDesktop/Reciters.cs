...
public static class Reciters
{
    public static readonly List<Reciter> All = new()
    {
        ...
        new("banna", "Banna_32kbps", "Mahmoud Ali Al-Banna"),
        new("basfar", "Abdullah_Basfar_64kbps", "Abdullah Basfar"),
        new("basfar.q", "Abdullah_Basfar_32kbps", "Abdullah Basfar (32 kbps)"),
        new("ayyoub", "Muhammad_Ayyoub_64kbps", "Muhammad Ayyoub"),
        new("ayyob.q", "Muhammad_Ayyoub_32kbps", "Muhammad Ayyoub (32 kbps)"),
        new("akhdar.q", "Ibrahim_Akhdar_32kbps", "Ibrahim Al-Akhdar"),
